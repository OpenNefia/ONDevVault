...
And anyways, if a modder wants to create a new feat that changes the effects of the hypothetical `Feat_PotionPuddle` to spawn Putits fused with the effects of t